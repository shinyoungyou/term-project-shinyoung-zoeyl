...
class TestEvolvePokemon(TestCase):
    ...
    def test_evolve_pokemon_squirtle_has_evolved_into_wartortle_in_level_2(self, _):
        ...
        actual_evolved_pokemon_name = character['Starting Pokèmon']
